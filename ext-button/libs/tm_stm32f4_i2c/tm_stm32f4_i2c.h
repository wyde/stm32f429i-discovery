...
extern void YD_Arduino_Wrtie(I2C_TypeDef*, uint8_t, uint8_t);

extern void YD_Arduino_WrtieMulti(I2C_TypeDef*, uint8_t, uint8_t*, uint16_t);

extern void YD_Arduino_ReadMulti(I2C_TypeDef*, uint8_t,  uint8_t*, uint16_t); 

extern uint8_t YD_Arduino_Read(I2C_TypeDef*, uint8_t);
