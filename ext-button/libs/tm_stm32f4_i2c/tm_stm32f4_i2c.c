...
void YD_Arduino_Write(I2C_TypeDef* I2Cx, uint8_t address, uint8_t data) {
	TM_I2C_Start(I2Cx, address, I2C_Direction_Transmitter, 0);
	TM_I2C_WriteData(I2Cx, data);
	TM_I2C_Stop(I2Cx);
}

void YD_Arduino_WriteMulti(I2C_TypeDef* I2Cx, uint8_t address, uint8_t* data, uint16_t count) {
	uint8_t i;
	TM_I2C_Start(I2Cx, address, I2C_Direction_Transmitter, 0);
	for (i = 0; i < count; i++) 
		TM_I2C_WriteData(I2Cx, data[i]);
...
void YD_Arduino_ReadMulti(I2C_TypeDef* I2Cx, uint8_t address,  uint8_t* data, uint16_t count) 
{
	uint8_t i;
	TM_I2C_Start(I2Cx, address, I2C_Direction_Receiver, 1);
	for (i = 0; i < count; i++) {
...
uint8_t YD_Arduino_Read(I2C_TypeDef* I2Cx, uint8_t address) 
{
	uint8_t received_data;
	TM_I2C_Start(I2Cx, address, I2C_Direction_Receiver, 0);
	received_data = TM_I2C_ReadNack(I2Cx);
